...
const SoldOffMarket: React.FC<Props> = ({ getData, updateData }) => {
  ...
  useEffect(() => {
    getData.execute(
      setProperties,
      (el: object) =>
        el.property.status === 'Sold' || el.property.status === 'OffTheMarket',
    );
  }, []);
